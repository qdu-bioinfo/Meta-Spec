...
def parse_args():
    ...
    parser.add_argument('--o', type=str, default='res/')
    parser.add_argument('--m', type=str, default='meta_spec.model')   
    parser.add_argument('--msi_model', type=str, default='msi.model')   
    parser.add_argument('--disease_name', type=str, default='ibs thyroid migraine autoimmune lung_disease')   
